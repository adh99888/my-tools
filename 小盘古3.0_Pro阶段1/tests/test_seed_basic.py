...
try:
    ...
    from src.core.protocol_engine import ProtocolLevel, ProtocolRequest
    from src.core.heartbeat import HeartbeatRecord
    from src.evolution.self_diagnosis import SystemDiagnosis
    from src.utils.logger import LogType
